...
// You supply the percentage of progress (from 0 to 1), the start value, the end value, and the one or two control values. The functions return the interpolated points.
...
float CubicBezierLength(CGPoint start, CGPoint c1, CGPoint c2, CGPoint end)
{
    ...
    CGPoint current;
    CGPoint previous = CGPointMake(0.f, 0.f);
    float length = 0.0;
