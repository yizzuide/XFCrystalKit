...
@implementation EmbossingAShape

/**
 *  Applying both a dark inner shadow to the bottom left and a light inner shadow to the top right creates the embossed effect
 *
 */
- (void)drawRect:(CGRect)rect {
    ...
    DrawInnerShadow(heartPath, WHITE_LEVEL(0, 0.5f), CGSizeMake(-4, 4), 4);
    DrawInnerShadow(heartPath, WHITE_LEVEL(1, 0.5f), CGSizeMake(4, -4), 4);
}
